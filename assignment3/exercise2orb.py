...
orb = cv.ORB_create(nfeatures = 20000, nlevels=5)
...
if args.save == 1:
    ...
    cv.imwrite(args.img1.replace(".png", "")+'ex2_orb'+ ransac_lmeds_str +'.png', np.hstack((img5, img3)))
...
if args.warp == 1:
    ...
    if args.save == 1:
        ransac_lmeds_str ='_ransac' if args.useRansac == 1 else '_lmeds'
        cv.imwrite(args.img1.replace(".png", "")+'ex2_orb_warped'+ ransac_lmeds_str +'.png', np.hstack((corrected_img1, corrected_img2)))
