...
brisk = cv.BRISK_create(thresh=25, octaves=9) #tresh, octaves, patternScale https://docs.opencv.org/3.4/de/dbf/classcv_1_1BRISK.html
# find the keypoints and descriptors with SIFT
kp1, des1 = brisk.detectAndCompute(img1,None)
kp2, des2 = brisk.detectAndCompute(img2,None)

#fix from https://answers.opencv.org/question/11209/unsupported-format-or-combination-of-formats-in-buildindex-using-flann-algorithm/
...
if args.save == 1:
    ...
    cv.imwrite(args.img1.replace(".png", "")+'ex2_brisk'+ ransac_lmeds_str +'.png', np.hstack((img5, img3)))
...
if args.warp == 1:
    ...
    if args.save == 1:
        ransac_lmeds_str ='_ransac' if args.useRansac == 1 else '_lmeds'
        cv.imwrite(args.img1.replace(".png", "")+'ex2_brisk_warped'+ ransac_lmeds_str +'.png', np.hstack((corrected_img1, corrected_img2)))
