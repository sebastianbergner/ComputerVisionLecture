...
gfilters = create_gaborfilter(sigma=1.0)
image_g = apply_filter(im, gfilters)
helpers.showimages(gfilters, (18, 6), txt='num_filters = 4, kernel_size=20, sigma=1.0, lambd=5.5, gamma=0.5, psi=0.1')
helpers.showimage(image_g)


gfilters = create_gaborfilter(lambd=1.5)
image_g = apply_filter(im, gfilters)
helpers.showimages(gfilters, (18, 6), txt='num_filters = 4, kernel_size=20, sigma=2.5, lambd=1.5, gamma=0.5, psi=0.1')
helpers.showimage(image_g)


gfilters = create_gaborfilter(gamma=0.25)
image_g = apply_filter(im, gfilters)
helpers.showimages(gfilters, (18, 6), txt='num_filters = 4, kernel_size=20, sigma=2.5, lambd=5.5, gamma=0.25, psi=0.1')
helpers.showimage(image_g)


gfilters = create_gaborfilter(psi=0.0)
image_g = apply_filter(im, gfilters)
helpers.showimages(gfilters, (18, 6), txt='num_filters = 4, kernel_size=20, sigma=2.5, lambd=5.5, gamma=0.5, psi=0.0')
helpers.showimage(image_g)